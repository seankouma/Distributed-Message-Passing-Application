...
public class HashTask implements Task {
    ...
    public HashTask(ConcurrentHashMap<SocketChannel, Integer> countProcessed, LinkedBlockingDeque<BatchUnit> batchQueue, AtomicInteger total) {
    ...
    public void executeTask() {
        for (BatchUnit unit : batchQueue) {
            ...
            try {
                ...
                // System.out.println("Size: " + countProcessed.size());
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
